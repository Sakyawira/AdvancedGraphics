...
//movement
void ssAnimatedModel::move(float moveDirection) {
	currentPlayerSpeed = playerSpeed * moveDirection;

	//printf("CurrentPlayerSpeed: %f \n", currentPlayerSpeed);
}

void ssAnimatedModel::rotate(float rotDirection) {
...
void ssAnimatedModel::setRotSpeed(float _rotSpeed){

	this->playerRotSpeed = _rotSpeed;
