...
Shader::Shader(const char* VertexShaderFilename, const char* FragmentShaderFilename, const char* TessControlShaderFilename, const char* TessEvalShaderFilename, const char* geometryShaderFilename, std::vector<Shader*>& shaderVector)
{
	m_program = ShaderLoader::CreateProgram(VertexShaderFilename, FragmentShaderFilename, TessControlShaderFilename, TessEvalShaderFilename, geometryShaderFilename);
	shaderVector.push_back(this);
}
